...
public final class MainModule$$ModuleAdapter extends ModuleAdapter<MainModule> {
   ...
   *
   * Owning the dependency links between {@code org.pawelszymczyk.UserService} and its
   * dependencies.
   *
  ...
  public static final class UserServiceProvidesAdapter extends ProvidesBinding<UserService>
    ...
    public void attach(Linker linker) {
      userRepository = (Binding<UserRepository>) linker.requestBinding("org.pawelszymczyk.UserRepository", MainModule.class, getClass().getClassLoader());
    }
    ...
    public UserService get() {
      return module.userService(userRepository.get());
    }
  }
